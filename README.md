...
* divelab/DIG DIG 工具包支持 4 个研究方向：图生成、图自监督学习、图神经网络可解释性以及 3D 图深度学习。对于每个领域，DIG 都提供了通用、可扩展的数据接口、常用算法与评估标准实现。
...
* ## 机器阅读理解
  ...
  * qiufengyuyi/event_extraction 百度aistudio事件抽取比赛 使用机器阅读理解的方式来尝试解决。
